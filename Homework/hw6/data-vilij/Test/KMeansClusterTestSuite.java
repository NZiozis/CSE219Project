...
public class KMeansClusterTestSuite{
    ...
    public void validConfiguration(){
        ArrayList<Integer> inputs = getInputs("3", "1", "2", false);
    ...
    public void invalidInputNUmberOfLabelsChosenLessThanTwo(){
        ArrayList<Integer> inputs = getInputs("20", "5", "0", true);
        ArrayList<Integer> inputs1 = getInputs("20", "5", "-4", true);
        ArrayList<Integer> inputs2 = getInputs("20", "5", "1", true);
